...
def show_release_notes():
    ...
    release_notes_layout = [
        ...
        [sg.Column([
            ...
            [sg.Text("• Enhanced 'Add Session' button in action dialogs and statistics tab")],
            [sg.Text("• Improved manual session dialog with better layout and validation")],
            [sg.Text("• Automatic start time calculation when using duration + end time method")],
            [sg.Text("• Seamless integration of manual sessions with existing session tracking")],
            [sg.Text("• Modularized session management (75% size reduction)")],
            [sg.Text("• Created focused modules: session_data, session_display, session_ui, session_visualizations")],
            [sg.Text("• All imports moved to top of files for better maintainability")],
            [sg.Text("• Removed scattered inline imports throughout codebase")],
            [sg.Text("• Fixed circular import dependencies between modules")],
            [sg.Text("• Improved code readability for new developers")],
            [sg.Text("• Enhanced action dialog UI with horizontal button layout")],
            [sg.Text("")],
            ...
            [sg.Text("• Fixed layout structure problems causing UI elements to vanish")],
            [sg.Text("• Eliminated forced window resizing that broke dialog layouts")],
