...
from session_data import (
    ...
    # Session-format migrations were relocated here (GUI-free); re-exported so the
    # legacy UI's `from session_management import migrate_all_game_sessions` keeps
    # working until the legacy files are removed in Phase 5 step 3.
    migrate_all_game_sessions,
    migrate_session_to_unified_feedback,
    migrate_pauses_to_integrated_structure,
)
...
from session_visualizations import (
    ...
    # create_session_heatmap was relocated here (GUI-free); re-exported so the
    # legacy UI's `from session_management import create_session_heatmap` keeps
    # working until the legacy files are removed in Phase 5 step 3.
